...
### Что сделано:
 - Проведен сравнительный анализ фреймворков для Frontend разработки, был выбран React.

## **08.03.2025 - 09.03.2025**

### Что сделано:
 - Проведен сравнительный анализ сред разработки для Frontend разработки и баз данных, был выбран VS Code и pgAdmin4.

## **10.03.2025 - 11.03.2025**

### Что сделано:
 - Проведен сравнительный анализ платформ для разработки базы данных, был выбран PostgreSQL.

## **12.03.2025**

### Что сделано:
 - Проведен сравнительный анализ графических редакторов для Frontend разработки, была выбрана Figma.
