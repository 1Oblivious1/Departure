...
### Что сделано:
 - Проведен сравнительный анализ фреймворков для Frontend разработки, в результате чего был выбран React.JS.
 - Проведён сравнительный анализ сред разработки для Frontend и инструментов администрирования баз данных. По результатам анализа были выбраны VS Code и pgAdmin4.
 - Проведён сравнительный анализ платформ для разработки баз данных, в результате которого была выбрана PostgreSQL.
 - Проведён сравнительный анализ графических редакторов для Frontend-разработки, по результатам которого была выбрана Figma.
 - Проведён сравнительный анализ фреймворков для разработки веб-приложений на C#, в результате чего был выбран ASP.NET Core.
 - Проведён сравнительный анализ сред разработки, в результате которого была выбрана Visual Studio для работы с ASP.NET Core.
 - Проведён сравнительный анализ инструментов для тестирования API, в результате которого был выбран Postman.
 - Проведён сравнительный анализ фреймворков для работы с базами данных в .NET, в результате чего был выбран Entity Framework Core.
 - Проведён сравнительный анализ фреймворков для бекенд разработки C#, в результате чего был выбран ASP.NET Core.
