...
### Что сделано:
 - Проведен сравнительный анализ фреймворков для Frontend разработки,
 - Был проведён сравнительный анализ сред разработки для Frontend и инструментов администрирования баз данных. По результатам анализа были выбраны VS Code и pgAdmin4.
 - Был проведён сравнительный анализ платформ для разработки баз данных, в результате которого была выбрана PostgreSQL.
 - Был проведён сравнительный анализ графических редакторов для Frontend-разработки, по результатам которого была выбрана Figma.
