...
- **Инструменты**:
  ...
  - **Интеграционные тесты**: Postman, Swagger.
  - **Тестирование UI**: Cypress, Selenium.
...
Цель: Проверка защиты данных пользователей и системы.

| **Аспект**                      | **Описание теста**                                                                                   | **Критерии успеха**                                                                 |
|----------------------------------|-----------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| Аутентификация                  | Проверить защиту от несанкционированного доступа.                                                   | Пароли хэшируются, система защищена от брутфорса.                                  |
| Авторизация                     | Проверить права доступа к данным (например, только модераторы могут проверять задания).              | Пользователи не могут получить доступ к чужим данным.                              |
| Защита API                      | Проверить защиту API от SQL-инъекций и XSS-атак.                                                    | API устойчив к атакам, данные передаются через HTTPS.                              |
| Хранение фотографий             | Проверить безопасность хранилища фотографий.                                                         | Фотографии недоступны для неавторизованных пользователей.                          |

---

##### **2.5. Тестирование удобства использования (UX/UI)**
