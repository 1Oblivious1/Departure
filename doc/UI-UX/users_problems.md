...
2. Интеграция с картами:
   - Отобразить задания на карте через API Яндекс.Карт.
   - Добавить кнопку "Показать на карте".
...
1. Отображение прогресса:
   - Добавить в профиле информацию о достижениях, количестве выполненных заданий и очков рейтинга.
   - Добавиц таблицу рейтинга по всем пользователям
2. Уведомления:
   - Добавить push-уведомления о новых комментариях или достижениях друзей.
   - Создать ленту активности на главной странице.
3. Социальное взаимодействие:
   - Добавить возможность ставить "лайки" или оставлять комментарии под фотографиями.
